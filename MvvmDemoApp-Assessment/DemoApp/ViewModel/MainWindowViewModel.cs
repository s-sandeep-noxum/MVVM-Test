	...
	public class MainWindowViewModel : WorkspaceViewModel
	{
			...
			return new List<CommandViewModel>
						{
								...
								new CommandViewModel(
										Strings.MainWindowViewModel_Command_Sales,
										new RelayCommand(param => this.CreateSales())),
		...
		void CreateNewCustomer()
		{
			try
			{
				...
				CustomerViewModel workspace = new CustomerViewModel(null, _customerRepository);
